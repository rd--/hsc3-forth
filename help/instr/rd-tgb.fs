\ tgb (rd)
: ln { l0 l1 } [ l0 1 -99 -99 l1 1 1 0 ] ;
: ln' { l0 l1 l2 } [ l0 2 -99 -99 l1 0.5 1 0 l2 0.5 1 0 ] ;
: mkls { env dur } 1 1 0 dur removeSynth env EnvGen.kr ;
...
;
10 s" /home/rohan/data/audio/metal.wav" 0 0 b_allocRead
10 30 tgb
play
